...
from app.controllers.public_controllers import sign_up_controller, sign_in_controller, index_users_controller
...
@public_blueprint.route('/all-users', methods=['GET'])
